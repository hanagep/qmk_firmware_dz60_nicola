...
// #include "key_duration.h" // Commented out, now in nicola.h
#include <avr/io.h>
#include <avr/pgmspace.h>
#include <avr/interrupt.h>

// Commented out to disable timer functionality
...
// Dummy functions to satisfy compilation if nicola.c still tries to call them
void keypress_timer_init(void (*_clbk)(void)) {}
void keypress_timer_start(uint16_t count) {}
