...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_directional(
        KC_KANA, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_GRV,  KC_BSPC,
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
        KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_DEL,
        KC_ESC,  KC_LGUI, KC_LALT, KC_SPC,  TD(TD_FN_IME), KC_SPC,  KC_WIN_SHFT_RIGHT, KC_TEAM_MUTE, KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_BASE_JP] = LAYOUT_directional(
        KC_KANA, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    JP_MINS, JP_CIRC, JP_YEN,  KC_BSPC,
    ...
    [_FN] = LAYOUT_directional(
        ...
        KC_TRNS, TG_JP,        KC_HOME, KC_UP,   KC_END,  KC_TRNS, KC_TRNS, KC_PGUP, KC_INS,  KC_DEL,  KC_PSCR, KC_SCRL, KC_PAUS, KC_TRNS,    
        KC_TRNS, LALT(KC_GRV), KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_TRNS, KC_INS,  KC_HOME, KC_PGUP, KC_BSPC, KC_TRNS,          KC_TRNS,
        KC_TRNS, KC_VOLD,      KC_VOLU, KC_MUTE, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL,  KC_END,  KC_PGDN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
        KC_CAPS, KC_TRNS,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MPRV, KC_MPLY, KC_MNXT
    ),

    [_NICOLA] = LAYOUT_directional(
        KC_EISU, NG_1,    NG_2,    NG_3,    NG_4,    NG_5,    NG_Q,    NG_W,    NG_E,    NG_R,    NG_T,    KC_MINS, KC_EQL,  KC_GRV,  KC_BSPC,
        ...
        KC_TRNS, KC_LGUI, KC_LALT, NG_SHFTL, TD(TD_FN_IME), NG_SHFTR,  KC_WIN_SHFT_RIGHT, KC_TEAM_MUTE, KC_LEFT, KC_DOWN, KC_RGHT
    )
};
